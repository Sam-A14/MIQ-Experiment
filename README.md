...
- `miq_experiment.py` — experiment runner
- `compute_scores.py` — CS/SAR/UPA/M-IQ scoring logic
- `miq_results.csv`, `miq_results_tinyllama.csv` — raw per-question results
- `miq_final_scores.csv`, `miq_final_scores_tinyllama.csv` — aggregated scores
